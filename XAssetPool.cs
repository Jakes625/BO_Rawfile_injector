...
namespace CallOfDuty.BlackOps
{
    ...
    public class RawPool
    {
        ...
        private const int XAssetPool = 0x1186DC0;
        private const int RawfileSize = 12; //original struct is 12 bytes.
        public const int PoolMax = 0x400;

        private const uint WRITE_ADDR = 0x2600250; //just found a bunch of empty space to write too, malloc would be better.
        ...
        public void ReadFree()
        {
            ...
            int addr = (firstUnused - XAssetPool);
            int unusedAddr;
